...
pub extern "C" fn mint() {
    ...
    TestStakingToken::default().mint(owner, amount).unwrap_or_revert();
}
...
pub extern "C" fn burn() {
    let owner: Address = runtime::get_named_arg(OWNER_RUNTIME_ARG_NAME);
    let amount: U256 = runtime::get_named_arg(AMOUNT_RUNTIME_ARG_NAME);
    TestStakingToken::default().burn(owner, amount).unwrap_or_revert();
}
...
pub extern "C" fn create_stake() {
    let owner: Address = runtime::get_named_arg(OWNER_RUNTIME_ARG_NAME);
    let amount: U256 = runtime::get_named_arg(AMOUNT_RUNTIME_ARG_NAME);
    TestStakingToken::default().create_stake(owner, amount).unwrap_or_revert();
}
...
pub extern "C" fn remove_stake() {
    let owner: Address = runtime::get_named_arg(OWNER_RUNTIME_ARG_NAME);
    let amount: U256 = runtime::get_named_arg(AMOUNT_RUNTIME_ARG_NAME);
    TestStakingToken::default().remove_stake(owner, amount).unwrap_or_revert();
}
...
fn call() {
    ...
    test_token
        .burn(TOKEN_OWNER_ADDRESS_1, U256::from(3*TOKEN_OWNER_AMOUNT_1))
        .unwrap_or_revert();
