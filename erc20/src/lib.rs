...
use constants::{
    ...
    NAME_KEY_NAME, SYMBOL_KEY_NAME, TOTAL_SUPPLY_KEY_NAME, STAKERS_KEY_NAME, STAKES_KEY_NAME,
    REWARDS_KEY_NAME,
};
pub use error::Error;
...
impl ERC20 {
    ...
    stakers_uref: URef, stakes_uref: URef, rewards_uref: URef) -> Self {
        Self {
    ...
    fn stakers_uref(&self) -> URef {
        *self
            .stakers_uref
            .get_or_init(stakes::stakers_uref)
    }
